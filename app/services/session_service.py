...
class SessionService:
    ...
    async def save_api_result(self, global_session_key: str, request: SolApiResultRequest) -> TurnResponse:
        """SOL 실시간 API 연동 결과를 턴 메타데이터로 저장."""
        ...
        await self.session_repo.add_turn(global_session_key, turn_data)
